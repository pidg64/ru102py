...
class SiteDaoRedis(SiteDaoBase, RedisDaoBase):
    ...
    def find_all(self, **kwargs) -> Set[Site]:
        ...
        site_hashes_keys = [self.key_schema.site_hash_key(site_id) for site_id in site_ids]
        site_hashes = [client.hgetall(site_hash_key) for site_hash_key in site_hashes_keys]
